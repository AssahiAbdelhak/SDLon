...
int printLayer(SDL_Window *widow,SDL_Surface * screen,int tiles[4160],char * nom_fichier,int firstgid, int tile_width,int tile_height);
int localisationValide(int x,int y);
void printSpirit(SDL_Window *widow,SDL_Surface * screen,char *nom_fichier,int x,int y);
void printMap(SDL_Window *widow,SDL_Surface * screen);
